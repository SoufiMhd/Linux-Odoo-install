...
DOMAIN_ALIASES=() # ("www.demo.das-360.com" "zzz.demo.das-360.com")
LE_EMAIL="@mail"
...
if [ $OE_VERSION = "11.0" ] || [ $OE_VERSION = "12.0" ] || [ $OE_VERSION = "13.0" ] || [ $OE_VERSION = "14.0" ] || [ $OE_VERSION = "15.0" ] || [ $OE_VERSION = "16.0" ];
 then
    PYTHON_VERSION="3"
else
    PYTHON_VERSION="2"
